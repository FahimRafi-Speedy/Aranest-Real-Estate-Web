  ...
  return (
    <div className="flex flex-col md:flex-row bg-white shadow-lg rounded-xl overflow-hidden min-h-screen">
      ...
      <div className="hidden md:block md:w-96 relative">
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-transparent to-[rgba(0,0,0,0.5)] flex items-end p-4 rounded-bl-xl rounded-tl-xl">
      ...
      <div className="w-full md:w-[40rem] flex flex-col justify-center p-6 md:p-10">

        ...
        <div className="p-2 md:p-4">
                    ...
                    >
                        {images.map((image, index) => (
                            <Image
                                ...
                                width={image.width}
                                height={image.height}
                                className="object-cover w-full rounded-lg inline-block cursor-pointer"
                        ...
                        <div className="col-span-2 grid grid-rows-2 gap-2">
                            {images.slice(1, 3).map((src, index) => (
                                <Image
                                    ...
                                    className="w-full h-[29vh] object-cover rounded-lg shadow-lg cursor-pointer"
                        ...
                        <div className="col-span-2 grid grid-rows-3 gap-2">
                            ...
                            {images.length > 3 && (
                                ...
                                >
                                    ...
                                    />
                                    <div
                                        className="absolute inset-0 flex flex-col items-center justify-center text-white font-semibold">
                                        <FaImages size={30}/>
                                        <span>See More</span>
                                    </div>
                                </div>
            ...
            {fullscreenImage !== null && (
                <div className="fixed inset-0 bg-black bg-opacity-90 flex items-center justify-center z-50">
                    ...
                    <button className="absolute left-4 text-white text-3xl"
                            onClick={() => setFullscreenImage(fullscreenImage === 0 ? images.length - 1 : fullscreenImage - 1)}>
                        <MdChevronLeft/>
                    </button>
                    <Image src={images[fullscreenImage]} alt="Full Image"
                         className="max-w-full max-h-full object-contain rounded-lg"/>
                    <button className="absolute right-4 text-white text-3xl"
